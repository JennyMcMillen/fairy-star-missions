...
const CACHE='fairy-star-missions-shell-1.7.1-launch';
const FILES=["./", "./app.js", "./art.js", "./assets/animations/alba-still.webp", "./assets/animations/franco-cuddle.webp", "./assets/animations/franco-still.webp", "./assets/animations/orion-cuddle.webp", "./assets/animations/orion-still.webp", "./assets/characters/alba.webp", "./assets/characters/franco.webp", "./assets/characters/orion.webp", "./assets/fairies/blossom.webp", "./assets/fairies/bubbles.webp", "./assets/fairies/garden.webp", "./assets/fairies/moon.webp", "./assets/fairies/rainbow.webp", "./assets/fairies/sunshine.webp", "./assets/rooms/aubrey.webp", "./assets/rooms/bathroom.webp", "./assets/rooms/bedroom.webp", "./assets/rooms/dining.webp", "./assets/rooms/garden.webp", "./assets/rooms/hallway.webp", "./assets/rooms/kitchen.webp", "./assets/rooms/living.webp", "./assets/rooms/study.webp", "./celebrations.js", "./data.js", "./db.js", "./engine.js", "./fairy-cast.js", "./icons/apple-touch-icon.png", "./icons/icon-192.png", "./icons/icon-512.png", "./icons/icon.svg", "./index.html", "./layout.js", "./lists.js", "./manifest.webmanifest", "./styles.css", "./world.js"];
