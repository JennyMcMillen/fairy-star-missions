...
const missions=[
 ...
 M('bedtime','Go happily to bed','bonus',2,'bedroom','bed',['independent']),
 M('listen','Listen the first time','behaviour',1,'garden','tree',['independent','team']),
 M('wait','Wait for my turn to talk','behaviour',1,'garden','tree',['team']),
 M('nice','Be kind to Aubrey','behaviour',1,'aubrey','teddy',['team']),
 M('voice','Use my inside voice','behaviour',1,'garden','tree',['team']),
 M('please','Say please and thank you first time','behaviour',1,'garden','tree',['team']),
 M('homework','Do my homework','learning',2,'study','desk',['independent']),
 M('read','Read for 10 minutes','learning',1,'living','books',['independent']),
 M('tidy-front-room','Tidy the front room','bonus',1,'living','toys',['helper'],{repeatable:true}),
 M('maths','Try 5 maths puzzles','learning',1,'study','maths',['independent']),
 M('phonics','Try 5 phonics tests','learning',1,'study','letters',['independent']),
 M('spelling','Try 5 spelling tests','learning',1,'study','letters',['independent']),
 M('food','Try a new food','bonus',1,'dining','plate',['extra'],{repeatable:true}),
 M('help-tea','Help with tea','bonus',1,'kitchen','help',['helper']),
 ...
 M('sorry','Say sorry without being asked','bonus',2,'garden','tree',['team'],{unprompted:true}),
